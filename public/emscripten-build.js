...
// include: /var/folders/ny/mh33wh_n2fj9h7dx06fcwgmw0000gn/T/tmp5dbaem_z.js
...
(() => {
  ...
  function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "emscripten-build.data";
    var REMOTE_PACKAGE_BASE = "emscripten-build.data";
    if (
    ...
    function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_emscripten-build.data");
      }
      Module["addRunDependency"]("datafile_emscripten-build.data");
  ...
  loadPackage({
    files: [
      { filename: "/assets/grass.png", start: 0, end: 114 },
      { filename: "/assets/placeholder.png", start: 114, end: 928 },
    ],
    remote_package_size: 928,
  });
})();

// end include: /var/folders/ny/mh33wh_n2fj9h7dx06fcwgmw0000gn/T/tmp5dbaem_z.js
...
var _setColor = (Module["_setColor"] = (a0, a1, a2) =>
  (_setColor = Module["_setColor"] = wasmExports["setColor"])(a0, a1, a2));
